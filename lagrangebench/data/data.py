...
class H5Dataset(Dataset):
    ...
    def __init__(
        ...
        self.db_hdf5 = None
        dt_raw       = self.metadata["dt"]
        write_every  = self.metadata.get("write_every", 1)
    ...
    def get_trajectory(self, idx: int):
        ...
        return pos_input, particle_type, frame_idxs * self.dt
    ...
    def get_window(self, idx: int):
        ...
        return pos_input_and_target, particle_type, frame_idxs * self.dt
